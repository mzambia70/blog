...
class Submount(RuleFactory):
    """Like `Subdomain` but prefixes the URL rule with a given string::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            Submount('/blogs', [
                Rule('/', endpoint='blogs/index'),
                Rule('/entry/<entry_slug>', endpoint='blogs/show')
            ])
        ])

    Now the rule ``'blogs/show'`` matches ``/blogs/entry/<entry_slug>``.
    """
...
class EndpointPrefix(RuleFactory):
    ...
    another string. This can be useful for sub applications::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            EndpointPrefix('blogs/', [Submount('/blogs', [
                Rule('/', endpoint='index'),
